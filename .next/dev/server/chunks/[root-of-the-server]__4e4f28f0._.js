...
async function POST(req) {
    try {
        ...
        if (geminiKey && geminiKey.length > 10 && !geminiKey.includes('your_')) {
            try {
                const genAI = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$google$2f$generative$2d$ai$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["GoogleGenerativeAI"](geminiKey);
        ...
        try {
            ...
            if (wikiRes.ok) {
                ...
                if (wikiData.extract) {
                    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                        reply: `(Fallback AI Mode): Here is what I found on Wikipedia about "${searchTerms}"...\n\n${wikiData.extract}`
                    });
                }
            }
        } catch (e) {
